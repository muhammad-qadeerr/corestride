    ...
    <ComponentTransition className="h-auto max-w-[1500px] px-10 xl:px-20 pb-20">
      ...
      <div className="flex justify-center items-center flex-col">
        <p className="text-base md:text-2xl text-neutral-500 md:w-[70%] text-center">
          We are passionate about creating innovative software solutions that transform businesses 
          and drive digital success through cutting-edge technology and exceptional craftsmanship.
        </p>
      </div>
      <CardAbout />
