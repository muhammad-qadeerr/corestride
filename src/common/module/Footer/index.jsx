        ...
        {FooterItem?.map((item, index) => (
          ...
          >
            ...
            <div className="md:px-2 md:py-2 px-2 py-[4px] flex">
              <Link href={item.child_1.href} className="" onClick={() => startNavigation()}>
                <TextAnimated
            ...
            <div className="md:px-2 md:py-2 px-2 py-[4px] flex">
              <Link href={item.child_2.href} className="" onClick={() => startNavigation()}>
                <TextAnimated
                  className=" text-base overflow-hidden text-neutral-700 dark:text-neutral-300 hover:text-neutral-900 hover:dark:text-neutral-800"
                  delay={1}
                >
            ...
            <div className="md:px-2 md:py-2 px-2 py-[4px] flex">
              <Link href={item.child_3.href} className="" onClick={() => startNavigation()}>
                <TextAnimated
                  delay={1}
                  className=" text-base overflow-hidden text-neutral-700 dark:text-neutral-300 hover:text-neutral-900 hover:dark:text-neutral-800"
                >
